...
import silentcrypto.hash.HashFactory;
import silentcrypto.mac.MacFactory;
import silentcrypto.sasl.ClientFactory;
import silentcrypto.sasl.ServerFactory;
import silentcrypto.key.KeyPairGeneratorFactory;
import silentcrypto.sig.SignatureFactory;
...
public final class GnuCrypto extends Provider {
   ...
   public static final Set getSecureRandomNames() {
      ...
      Set md = silentcrypto.hash.HashFactory.getNames();
