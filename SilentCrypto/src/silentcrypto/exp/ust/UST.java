...
import silentcrypto.mac.TMMH16;
import silentcrypto.prng.ICMGenerator;
import silentcrypto.prng.IRandom;
import silentcrypto.prng.PRNGFactory;
import silentcrypto.prng.UMacGenerator;
 ...
 * available are (a) {@link silentcrypto.prng.UMacGenerator} and (b) {@link
 * silentcrypto.prng.ICMGenerator}. Yet, both of these two algorithms require more
 ...
 * the only such functions available are {@link silentcrypto.mac.UHash32} and
 * {@link silentcrypto.mac.TMMH16}, with the latter more suited for UST purposes
 ...
 * dependencies on {@link silentcrypto.mac.UMac32}; although this may change in
 * the future. For this reason we shall only allow {@link silentcrypto.mac.TMMH16}
